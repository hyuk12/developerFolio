...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ 시스템 통합을 위한 RESTful API 및 미들웨어 솔루션 설계 및 개발"
    ),
    emoji(
      "⚡ Java와 Spring Boot를 사용하여 고성능, 확장 가능한 백엔드 구현"
    ),
    emoji(
      "⚡ 실시간 통신을 위한 RabbitMQ 및 MQTT와 같은 메시지 브로커 통합"
    ),
    emoji(
      "⚡ Docker 및 Kubernetes를 사용하여 컨테이너화된 애플리케이션 배포 및 관리"
    ),
    emoji(
      "⚡ PostgreSQL 및 Redis를 사용한 효율적인 데이터 관리"
    )
  ],
...
const blogSection = {
  title: "블로그",
  subtitle:
    "백엔드 개발, 시스템 아키텍처 및 DevOps에 대한 여정과 통찰 공유.",
